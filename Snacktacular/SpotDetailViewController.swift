...
class SpotDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if spot == nil { //We are adding a new record, fields should be editable
            ...
            saveBarButton.title = "" //No is hidden property from this and cancel.
    ...
    func saveCancelAlert(title: String, message: String, segueIdentifier: String) {
        ...
        let saveAction = UIAlertAction(title: "Save", style: .default) { (_) in
            self.spot.saveData { success in //This is called trailing closure syntax
...
extension SpotDetailViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.review = reviews.reviewArray[indexPath.row] //This is a property observer...
        return cell
    }
}
