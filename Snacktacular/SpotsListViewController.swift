...
class SpotsListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        spots = Spots() //Created an empty class in spots
    }
    ...
    func signIn() {
        ...
        if authUI.auth?.currentUser == nil { //If we don't have a current user logged in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        } else { //Must have clicked on the show spot, need to unselect anything that had been previously selected
